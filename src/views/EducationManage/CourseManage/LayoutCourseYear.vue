...
export default {
  ...
  methods: {
    ...
    resizeLayout() {
      setTimeout(() => {
        ...
        $(".layout-course-year .table-box").height(tblH);
        $(".layout-course-year .course-list").height(tblH + cpH + 40);
        console.log(66, icH, etH, ttH, tblH);
        // console.log(66, icH,etH,ltH)
        let leftTreeH = icH - etH - ltH - elInputH - 30;
        $(".layout-course-year .m-left .inner .el-tree").height(leftTreeH);
      }, 50);
    },
    /**
     *  @function: 树形图点击
    ...
    cellClick(row, column, cell, event) {
      ...
      // console.log("checkedObj.label",this.checkedObj.label,column.property);
      ...
      this.$api.EducationManage.getTimetables("get", params)
        .then(res => {
          ...
          if (res.data.code == 600 || res.data.code == 0) {
            ...
            //     item["subject_name" + data[i][k].week] =
            //       data[i][k].subject_name;
            //     item["subject_teacher" + data[i][k].week] =
            //       data[i][k].subject_teacher;
            //   }
    ...
    beforeUpload(file) {
      ...
      this.uploadParams.schoolyear_id = this.yearid;
     ...
     *  @date 2019-02-16
     */
    getTimetablesYearList() {
      let params = {
        schoolid: localStorage.getItem('schoolId')
      };
      this.tableLoading = true;
      this.$api.EducationManage.getTimetablesYearList("get", params)
        .then(res => {
          console.log("获取排课学年下拉列表", res.data);
          if (res.data.code == 600 || res.data.code == 0) {
    ...
    postTimetablesCopy() {
      let params = {
        origin_schoolyear_id: this.copyForm.yearid,
        target_schoolyear_id: this.yearid,
        school_id: localStorage.getItem("schoolId")
      };
  ...
  created() {
    this.getTimetablesYearList(); //排课学年下拉列表
