  ...
  methods: {
    ...
    resizeLayout() {
      setTimeout(() => {
        ...
        $(".select-course-year .table-box").height(tblH);
        $(".select-course-year .course-list").height(tblH + cpH + 40);
        console.log(66, icH, etH, ttH, tblH);
        // console.log(66, icH,etH,ltH)
        let leftTreeH = icH - etH - ltH - elInputH - 30;
        $(".select-course-year .m-left .inner .el-tree").height(leftTreeH);
      }, 50);
    },
    /**
     *  @function: 树形图点击
